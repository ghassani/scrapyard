"use strict";
game.module('game.hero.class.ninja.action.battle.attack')
.require(
...
.body(function() {
    /**
     * NinjaAttackBattleAction - Ninja attack action
     */
    game.createClass('NinjaAttackBattleAction', 'AttackBattleAction', {
        prepare : function() {
