...
.body(function () {
    ...
    Box2D.Body.prototype.GetX = function () {
        return this.m_xf.position.x;
    };

    Box2D.Body.prototype.GetY = function () {
        return this.m_xf.position.y;
    };
    ...
    Box2D.Body.prototype.SetAngle = function (angle) {
        this.SetPositionAndAngle(this.m_xf.position, angle);
    };
