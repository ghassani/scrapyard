 ...
 */
class OrderAdminEventListener
{
    
    /**
     * 
     */
    public function __construct(ConfigurationManager $configurationManager, OrderHelper $orderHelper, TwigEngine $templating, \Swift_Mailer $mailer)
    {
