...
class TwitterFactory extends AbstractFactory
{
    ...
    {
        return 'commerce.security.authentication.listener.twitter';
    }

    protected function createAuthProvider(ContainerBuilder $container, $id, $config, $userProviderId)
    {

        $authProviderId = 'commerce.security.authentication.provider.twitter.'.$id;

        $definition = $container
            ->setDefinition($authProviderId, new DefinitionDecorator('commerce.security.authentication.provider.twitter'))
    ...
    {
        $entryPointBase = 'commerce.security.authentication.entry_point.twitter';
