...
/**
 * CategoryProductFilterFormType
 *
 * @author Gassan Idriss <ghassani@splicedmedia.com>
 */
class CategoryProductFilterFormType extends AbstractType
{
    /**
     * Constructor
     *
    ...
    {
       if (!isset($this->category) || !$this->category instanceof CategoryInterface) {
           throw new \RuntimeException('Category Must Be Set When Using CategoryProductFilterFormType');
       }
