...
class ProjectTemplateExtension implements TemplateExtensionImplementerInterface
{
    const EXTENSION_KEY = 'spliced_pms_project';
    const EXTENSION_NAME = 'Project Loader';
    const EXTENSION_DESCRIPTION = 'Load one project for display in a template';
    ...
    {
        if (!isset($settings['projectIds']) || empty($settings['projectIds'])) {
    ...
    {
        return 'SplicedProjectManagerBundle:CmsExtension:project_settings_form.html.twig';
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return 'SplicedProjectManagerBundle:CmsExtension:project_settings_view.html.twig';
    }
}